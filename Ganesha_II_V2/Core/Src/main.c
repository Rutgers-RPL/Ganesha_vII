...
// TODO: Remove after Matt finishes his launch
int camera_timer_counter = 0;

// Triggers when the timer has run, shutdowns the camera
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim){
  if (camera_fired == 1) {
    ++camera_timer_counter;
    if (camera_timer_counter >= 2) {
      //  Timer Stopped
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : GYR_CS_Pin ACC_CS_Pin MAG_CS_Pin */
  GPIO_InitStruct.Pin = GYR_CS_Pin|ACC_CS_Pin|MAG_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : PB1 PB2 PYRO1_FIRE_Pin LED_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_2|PYRO1_FIRE_Pin|LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : CAM_FIRE_Pin PYRO0_FIRE_Pin */
  GPIO_InitStruct.Pin = CAM_FIRE_Pin|PYRO0_FIRE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
